...
```
* **권장 브랜치명**: `docs/S15P11E101-XXX-select-telemetry-protocol`
* **커밋 메시지 예시**: `[S15P11E101-XXX] docs: 로봇-서버 간 통신 프로토콜 최종 합의 내용 반영`
...
```
* **권장 브랜치명**: `docs/S15P11E101-YYY-select-video-architecture`
* **커밋 메시지 예시**: `[S15P11E101-YYY] docs: 실시간 비디오 스트리밍 아키텍처 최종 의사결정 결과 반영`
