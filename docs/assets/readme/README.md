...
| 파일 | 슬라이드 | 내용 |
| --- | --- | --- |
| `hero.svg` | - | README 전용 프로젝트 커버. 저장소 내에서 직접 제작 |
...
정지 이미지는 원본 파일을 사용합니다. 지도 생성·반복 순찰·화재 경보·복구·열화상 GIF는 해상도, 프레임 수, 색상 수를 줄여 재인코딩했으며 재생 속도는 유지했습니다. README 전용 SVG 커버를 포함한 전체 자료 19개는 약 **30.93 MiB**입니다. 원본 용량이 큰 전체 MOV/MP4 영상은 저장소에 추가하지 않았습니다.
