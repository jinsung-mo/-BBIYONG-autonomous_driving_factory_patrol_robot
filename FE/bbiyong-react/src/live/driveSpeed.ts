 ...
 */
export function getDriveSpeed(accessToken: string | null | undefined, robotId?: string) {
 ...
 * @returns {Promise<import('./contracts').DriveSpeed>}
 */
export function putDriveSpeed(
  { maxLinear, maxAngular }: { maxLinear: number, maxAngular: number },
 ...
 */
export function speedProblems(maxLinear: number, maxAngular: number) {
  const bad = []
