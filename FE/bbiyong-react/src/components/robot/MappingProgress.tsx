...
//
// 매핑이 도는 동안 지도(서브탭)에는 확정된 지도가 없다. 그리는 중인 격자를 여기에
// 흘리면 조작자가 그것을 완성된 지도로 읽는다 — 실시간 진행은 '매핑' 서브탭에서 본다.
//
  ...
  return (
    <div className="map-mapping" role="status" aria-live="polite">
      ...
      <span className="map-mapping-hint">
        그려지는 지도는 위 <b>매핑</b> 탭에서 실시간으로 볼 수 있습니다.
        매핑이 끝나면 이 화면이 3D 도면으로 바뀝니다.
      </span>
    </div>
  )
}
